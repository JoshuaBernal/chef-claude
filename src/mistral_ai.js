...
Start with this statement "Based on the ingredients you provided, I would recommend making a..." Then, 
for the actual name of the recipe, make sure that they are formatted in bold.
`

const hf = new HfInference(process.env.MISTRAL_AI_API_KEY)
